...
// 4.7 -> "4,7 ч"
export function formatServiceTime(value: number | null | undefined): string {
  if (isEmpty(value)) return '—'
...
interface HigherIsBetterOptions {
...
export function isDeltaPositive(
  delta: number | null | undefined,
  { higherIsBetter = true }: HigherIsBetterOptions = {}
): boolean | null {
...
export function formatShortName(value: unknown): string {
